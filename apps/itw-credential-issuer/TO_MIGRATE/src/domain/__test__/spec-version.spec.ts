...
import { SPEC_VERSION_HEADER, SpecVersionError, resolveSpecVersionFromHeaders } from '../spec-version';

describe('spec-version', () => {
  it('defaults missing header to V1_0', () => {
    expect(resolveSpecVersionFromHeaders(new Headers())).toBe(ItWalletSpecsVersion.V1_0);
  });
