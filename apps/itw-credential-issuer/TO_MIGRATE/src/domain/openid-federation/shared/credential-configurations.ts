...
import {
  DISABILITY_CARD_SCOPE,
  DISABILITY_CARD_VCT,
} from "@/domain/credentials/disability-card";
import {
  PID_MDOC_DOCTYPE,
...
import { pidIdentification } from "./constants";

export const dc_sd_jwt_PersonIdentificationData = (
  baseURL: string,
    ...
    },
    {
      ...
      path:
        specVersion === ItWalletSpecsVersion.V1_3
          ...
          : ["birth_place"],
      value_type:
        specVersion === ItWalletSpecsVersion.V1_3 ? "place_of_birth" : "string",
    },
    {
      display: [
        {
  ...
  claims: [
    ...
    },
    {
      display: [
        {
          locale: "it-IT",
          name: "Indennità di assistenza continua",
        },
        {
          locale: "en-US",
...
export const mso_mdoc_PersonIdentificationData = (
  baseURL: string,
  specVersion: ItWalletSpecsVersion,
) => ({
  claims: [
      ...
      : [
          {
            display: [
              ...
              {
                locale: "en-US",
                name: "National tax identification code",
              },
            ],
            mandatory: false,
