...
import { DISABILITY_CARD_SCOPE, DISABILITY_CARD_VCT } from '@/domain/credentials/disability-card';
import { PID_MDOC_DOCTYPE, PID_MDOC_IT_NAMESPACE, PID_MDOC_NAMESPACE } from '@/domain/mdoc';
