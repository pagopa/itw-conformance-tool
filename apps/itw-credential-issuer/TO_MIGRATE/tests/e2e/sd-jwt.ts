...
export const createMockedVpToken: CreateMockedVpToken = async (payload, header, nonce, client_id) => {
  const privateKey = await importJWK(appContext.repository.jwks.getSign().private, 'ES256');
