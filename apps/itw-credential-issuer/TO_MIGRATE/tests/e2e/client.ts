import { getSignJwtCallback, callbacks as partialCallbacks } from '@/domain/crypto';
import { WalletProvider } from '@pagopa/io-wallet-oid4vci';
import { IoWalletSdkConfig, ItWalletSpecsVersion, addSecondsToDate } from '@pagopa/io-wallet-utils';
...
export const callbacks = {
  ...partialCallbacks,
  fetch,
  signJwt: getSignJwtCallback([requestProofJwk, dpopJwk, accessTokenJwk, walletProviderJwk])
};
...
export const getClientId = async (): Promise<string> => calculateJwkThumbprint(dpopJwkPublic);
