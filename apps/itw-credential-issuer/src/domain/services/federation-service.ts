...
export class FederationService {
  ...
  getEntityConfiguration(baseURL: string, config: IoWalletSdkConfig): Promise<string> {
    return getFederationMetadata({ baseURL, config, jwksRepository: this.#jwksRepository });
  }
}
