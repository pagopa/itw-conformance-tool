  ...
  return {
    ...
    requiredEvents: [
      ...
      },
      {
        ...
        label: `Credential Issuer returned an Authorization Response without '${claimLabel}'`,
        service: 'credential-issuer',
        correlation: 'allow-uncorrelated-post-start',
    ...
    instructions: {
      ...
      summary: `Verify rejection of an Authorization Response missing '${claimLabel}'.`,
      prerequisites: [
      ...
      steps: [
        ...
        `Stop at the wallet rejection screen; the expected outcome is rejection because '${claimLabel}' is missing.`
      ]
    },
