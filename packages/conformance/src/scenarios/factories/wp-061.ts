...
export const wp061Scenario: ProtocolObservedScenarioDefinition = {
  ...
  requiredEvents: [
    ...
    },
    {
      ...
      label: 'Credential Issuer returned a credential with an untrusted x5c chain',
      service: 'credential-issuer',
      correlation: 'allow-uncorrelated-post-start',
      match: {
        endpoint: '/credential',
  ...
  instructions: {
    ...
    summary: 'Verify rejection of a credential with an untrusted x5c chain.',
    prerequisites: [
    ...
    steps: [
      ...
      'Observe the wallet rejection caused by the untrusted Trust Chain and keep this command running.'
    ]
  },
