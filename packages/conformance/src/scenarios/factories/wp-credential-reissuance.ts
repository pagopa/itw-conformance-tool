...
export const WP_CREDENTIAL_REISSUANCE_EXPIRED_REFRESH_TOKEN_TTL_SECONDS = 8;
...
export const wpCredentialReissuanceScenario: ProtocolObservedScenarioDefinition = {
  ...
  setup: {
    issuerConfig: {
      ...
      refreshTokenTtlSeconds: WP_CREDENTIAL_REISSUANCE_EXPIRED_REFRESH_TOKEN_TTL_SECONDS,
      statusList: {
        bits: 4,
