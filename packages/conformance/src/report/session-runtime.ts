...
import { getLatestOpenSessionId, updateSessionEntityName } from './session-store.js';

import type { Phase } from './types.js';

export function recordSessionEntityNameFromEntityConfiguration(phase: Phase, entityStatementClaims: unknown): void {
  ...
  try {
    ...
    const entityName = resolveEntityNameFromEntityConfiguration(phase, entityStatementClaims);
