...
import { getEntityConfigurationClaimsMetadataV1_0 } from './v1.0/entity-configuration-metadata.js';
import { getEntityConfigurationClaimsMetadataV1_3 } from './v1.3/entity-configuration-metadata.js';
