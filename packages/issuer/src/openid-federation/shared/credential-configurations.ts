...
export const dc_sd_jwt_PersonIdentificationData = (baseURL: string, specVersion: ItWalletSpecsVersion) => ({
  claims: [
    {
      display: [{ locale: 'it-IT', name: 'Nome' }, { locale: 'en-US', name: 'First Name' }],
      mandatory: true,
      path: ['given_name'],
      value_type: 'string',
    },
    {
      display: [{ locale: 'it-IT', name: 'Cognome' }, { locale: 'en-US', name: 'Family Name' }],
      mandatory: true,
      path: ['family_name'],
      value_type: 'string',
    },
    {
      display: [{ locale: 'it-IT', name: 'Data di nascita' }, { locale: 'en-US', name: 'Date of birth' }],
      mandatory: true,
      path: specVersion === ItWalletSpecsVersion.V1_3 ? ['birthdate'] : ['birth_date'],
      value_type: 'date',
    },
    {
      display: [{ locale: 'it-IT', name: 'Luogo di nascita' }, { locale: 'en-US', name: 'Place of birth' }],
      mandatory: true,
    ...
    {
      display: [{ locale: 'it-IT', name: 'Codice Fiscale' }, { locale: 'en-US', name: 'Tax id code' }],
      mandatory: true,
      path: ['personal_administrative_number'],
      value_type: 'string',
    },
    {
      display: [{ locale: 'it-IT', name: 'Nazionalità' }, { locale: 'en-US', name: 'Nationality' }],
      mandatory: true,
      path: ['nationalities'],
      value_type: 'array',
    },
    ...(specVersion === ItWalletSpecsVersion.V1_3
      ? [
          {
            display: [{ locale: 'it-IT', name: 'Data di scadenza' }, { locale: 'en-US', name: 'Date of expiry' }],
            mandatory: true,
            path: ['date_of_expiry'],
            value_type: 'string',
          },
          {
            display: [{ locale: 'it-IT', name: 'Identificativo univoco' }, { locale: 'en-US', name: 'Subject identifier' }],
            mandatory: true,
            path: ['sub'],
            value_type: 'string',
          },
          {
            display: [{ locale: 'it-IT', name: 'Verifica' }, { locale: 'en-US', name: 'Verification' }],
            mandatory: true,
            path: ['verification'],
...
export const mso_mdoc_mDL = (baseURL: string) => ({
  claims: [
    ...
    {
      display: [{ locale: 'it-IT', name: 'Maggiorenne' }, { locale: 'en-US', name: 'Age over 18' }],
      mandatory: false,
      path: ['org.iso.18013.5.1', 'age_over_18'],
      value_type: 'string',
    },
    {
      display: [{ locale: 'it-IT', name: 'Numero di documento' }, { locale: 'en-US', name: 'Document Number' }],
      mandatory: true,
      path: ['org.iso.18013.5.1', 'document_number'],
      value_type: 'string',
    },
    {
      display: [{ locale: 'it-IT', name: 'Categorie di veicoli' }, { locale: 'en-US', name: 'Driving Privileges' }],
      mandatory: true,
      path: ['org.iso.18013.5.1', 'driving_privileges'],
      value_type: 'driving_privileges',
    },
    {
      display: [{ locale: 'it-IT', name: 'Data di scadenza' }, { locale: 'en-US', name: 'Expiry Date' }],
      mandatory: true,
      path: ['org.iso.18013.5.1', 'expiry_date'],
      value_type: 'date',
    },
    {
      display: [{ locale: 'it-IT', name: 'Data di rilascio' }, { locale: 'en-US', name: 'Issue Date' }],
      mandatory: true,
      path: ['org.iso.18013.5.1', 'issue_date'],
      value_type: 'date',
    },
    {
      display: [{ locale: 'it-IT', name: "Autorità di rilascio" }, { locale: 'en-US', name: 'Issuing Authority' }],
      mandatory: true,
      path: ['org.iso.18013.5.1', 'issuing_authority'],
      value_type: 'string',
    },
    {
      display: [{ locale: 'it-IT', name: 'Paese di rilascio' }, { locale: 'en-US', name: 'Issuing Country' }],
      mandatory: true,
      path: ['org.iso.18013.5.1', 'issuing_country'],
      value_type: 'string',
    },
    {
      display: [{ locale: 'it-IT', name: 'Foto' }, { locale: 'en-US', name: 'Portrait' }],
      mandatory: true,
      path: ['org.iso.18013.5.1', 'portrait'],
      value_type: 'jpeg',
    },
    {
      display: [{ locale: 'it-IT', name: 'Firma' }, { locale: 'en-US', name: 'Signature Usual Mark' }],
      mandatory: false,
      path: ['org.iso.18013.5.1', 'signature_usual_mark'],
      value_type: 'jpeg',
    },
    {
      display: [{ locale: 'it-IT', name: 'Segno distintivo UN' }, { locale: 'en-US', name: 'UN Distinguishing Sign' }],
      mandatory: true,
...
export const dc_sd_jwt_EuropeanDisabilityCard = (baseURL: string) => ({
  claims: [
    {
      display: [{ locale: 'it-IT', name: 'Codice QR' }, { locale: 'en-US', name: 'QR Code' }],
      mandatory: true,
      path: ['link_qr_code'],
      value_type: 'string',
    },
    {
      display: [{ locale: 'it-IT', name: 'Nome' }, { locale: 'en-US', name: 'Name' }],
      mandatory: true,
      path: ['given_name'],
      value_type: 'string',
    },
    ...
    {
      display: [{ locale: 'it-IT', name: 'Codice Fiscale' }, { locale: 'en-US', name: 'Tax Identification Number' }],
      mandatory: true,
      path: ['personal_administrative_number'],
      value_type: 'string',
    },
    ...
    {
      display: [{ locale: 'it-IT', name: 'Numero' }, { locale: 'en-US', name: 'License number' }],
      mandatory: true,
      path: ['document_number'],
      value_type: 'string',
    },
    {
      display: [{ locale: 'it-IT', name: 'Fotografia' }, { locale: 'en-US', name: 'Portrait' }],
      mandatory: true,
      path: ['portrait'],
      value_type: 'string',
    },
